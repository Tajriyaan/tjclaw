# ════════════════════════════════════════════════════════════════
# 🦞 TJClaw — HuggingClaw fork by Tajriyaan
# Source: https://github.com/Tajriyaan/tjclaw
# ════════════════════════════════════════════════════════════════
...
# Install JupyterLab only when DEV_MODE is enabled at build time
ARG DEV_MODE=false
...
# Copy all HuggingClaw/TJClaw app files
