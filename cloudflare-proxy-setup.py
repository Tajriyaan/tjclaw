...
def render_worker(secret_value: str, allowed_targets: list[str], allow_proxy_all: bool) -> str:
    ...
    return f"""// HuggingClaw Cloudflare Proxy Worker
// Auto-generated by cloudflare-proxy-setup.py — do not edit manually.
export default {{
...
def main() -> int:
    ...
    try:
        ...
        cf_request(
            ...
            # FIX: module-format workers require this content-type
